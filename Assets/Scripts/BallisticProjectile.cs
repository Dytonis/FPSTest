...
public class BallisticProjectile : MonoBehaviour
{
    ...
    public virtual void OnPositionUpdate()
    {
        ...
        else
        {
            ...
            VisibleObject.transform.rotation = Quaternion.Euler(transform.forward);
        }
    ...
    public virtual bool ForwardRaycast(out RaycastHit hit)
    {
        ...
        bool b = Physics.Raycast(transform.position, Velocity.normalized, out h, Velocity.magnitude * Time.deltaTime);
